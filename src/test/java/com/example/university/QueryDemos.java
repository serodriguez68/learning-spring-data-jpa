...
public class QueryDemos {
     ...
     */
    @Test
    public void jpqlAndNativeQueries() {
        ...
        //*******Native Queries*******
        System.out.println("\nFind Courses that contain the substring 'li' in the name");
        courseRepository.findByFuzzyName("li").forEach(System.out::println);
    ...
    public void queryByExample() {
        ...
        Example<Department> example1 = Example.of(
                new Department(null, new Staff(new Person("John", null))));
        departmentRepository.findAll(example1).forEach(System.out::println);

        System.out.println("\nFind All Departments with the name ending in 'sciences', case insensitive");
        Example<Department> example2 = Example.of(
                new Department("sciences", null),
                ExampleMatcher.matching().
                        withIgnoreCase().
                        withStringMatcher(ExampleMatcher.StringMatcher.ENDING)
        );
        departmentRepository.findAll(example2).forEach(System.out::println);
    }
